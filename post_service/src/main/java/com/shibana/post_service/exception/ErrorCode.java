...
public enum ErrorCode {
    ...
    SERIALIZATION_ERROR(5000704, "post-service:: Serialization error", HttpStatus.INTERNAL_SERVER_ERROR),
    MISSING_TOPIC_ROUTING(5000804, "post-service:: Missing topic routing for aggregate type", HttpStatus.INTERNAL_SERVER_ERROR)
    ;
